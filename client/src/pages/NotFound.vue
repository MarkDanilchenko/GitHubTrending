      ...
      <div class="col-md-6 align-self-center">
        ...
        >
          <g>
            ...
            <g id="planet">
              <circle fill="none" stroke-width="3" stroke-miterlimit="10" cx="572.859" cy="108.803" r="90.788" />
              <circle
                id="craterBig"
                fill="none"
                stroke-width="3"
...
import animationNotFound from "#/mixins/animationNotFound.js";

export default {
  name: "NotFound",
  mixins: [animationNotFound],
  computed: {
    ...mapState({
      ...
      if (value === "dark") {
        document
          .querySelectorAll(
            "#planet *," +
              " #stars > #starsBig line," +
              " #stars > #starsSmall line," +
              " #stars > #circlesBig circle," +
              " #spaceman #cord," +
              " #spaceman #antenna",
          )
          .forEach((element) => {
