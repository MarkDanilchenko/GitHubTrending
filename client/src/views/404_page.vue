    ...
    <section class="my-404-page">
        <div class="row">
			...
			c0-3.378-15.347-4.988-40.243-7.225" />
                            <path id="ringShadow" opacity="0.5" fill="none" stroke-width="3" stroke-linecap="round"
			...
			M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149" />
                        ...
                        <g id="stars">
                            <g id="starsBig">
                                <g>
                                    <line fill="none" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                            ...
                            <g id="circlesBig">
                                <circle fill="none" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                        ...
                        <g id="spaceman" clip-path="url(cordClip)">
                            <path id="cord" fill="none" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z" />
				...
				s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z" />
                                <g clip-path="url(#GlassClip)">
                                    <polygon id="glassShine" fill="#079762" stroke="#0E0620" stroke-width="3"
...
export default {
    ...
    mounted() {
        if (this.colorMode === 'dark') {
            $('#planet *').attr('stroke', '#ffffff');
            $('#stars > #starsBig line, #stars > #starsSmall line, #stars > #circlesBig circle').attr('stroke', '#ffffff');
            $('#stars > #circlesSmall circle').attr('fill', '#ffffff');
            $('#spaceman #cord, #spaceman #antenna').attr('stroke', '#ffffff');
        } else {
            $('#planet *').attr('stroke', '#0E0620');
            $('#stars > #starsBig line, #stars > #starsSmall line, #stars > #circlesBig circle').attr('stroke', '#0E0620');
            $('#stars > #circlesSmall circle').attr('fill', '#0E0620');
            $('#spaceman #cord, #spaceman #antenna').attr('stroke', '#0E0620');
        }
    },
    watch: {
        colorMode: {
